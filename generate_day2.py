...
routes = {
    "10am-1015am": ("walking", "Head southeast on Okubo-dori, turn right onto Meiji-dori, then left into Shinjuku Gyoen entrance."),
    "1015am-1115am": ("walking", "Exit Shinjuku Gyoen, head north on Meiji-dori, turn left onto Okubo-dori to Himawari Sushi."),
    ...
    "230pm-5pm": ("walking", "Head northeast on Roppongi-dori, turn left onto Azabudai-dori, reach teamLab Borderless."),
...
for time, sections in {k: v for k, v in data.items() if k != "overview"}.items():
    ...
    # Extract stop name and duration from base
